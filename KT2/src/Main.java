    ...
    public static void main(String[] args) {
        ...
        if(authService.getCurrentAccount().getRole().equals(Role.ADMIN)){
            while(isRunning){
                ...
                System.out.println("Xin chào ADMIN: " + authService.getCurrentAccount().getUsername());
                adminMenu();
                    ...
                    case 5:
                        ...
                        for(Account ac: accountList){
                            if(ac.getUsername().equals(username3)){
                                ...
                                else ac.setStatus(Status.ACTIVE);
                            }
                            else{
            ...
            while(isRunning){
                ...
                System.out.println("Xin chào USER: " + authService.getCurrentAccount().getUsername());
                userMenu();
                ...
                switch (choice){
                    case 1:
                        System.out.println("Enter username and password in account want to change password: ");
                        String username = sn.nextLine();
